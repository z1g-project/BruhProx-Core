...
function hostnameErrorTemplate(fetchedURL, bareServer) {
    ...
    return (
        ...
        '<hr />' +
        '<p><i>BruhProx v<span id="uvVersion"></span></i></p>' +
        `<script src="${
...
function errorTemplate(
    ...
    return (
        ...
        '<li>Updating BruhProx</li>' +
        '<li>Troubleshooting the error on the <a href="https://github.com/z1g-project/bruhprox-core" target="_blank">GitHub repository</a></li>' +
        '</ul>' +
        '<button id="reload">Reload</button>' +
        '<hr />' +
        '<p><i>BruhProx v<span id="uvVersion"></span></i></p>' +
